...
if __name__ == "__main__":
    ...
    metabolite_synthesis_network_long = pd.merge(
        metabolite_synthesis_rxn_network_df.reset_index(
            ...
            id_vars="reaction", var_name="metabolite", value_name="to_keep"
        ),
        rxn_to_gene_df,
        how="left",
        left_on="reaction",
    ...
    metabolite_synthesis_network_long = cast(  # type: ignore
        pd.DataFrame,
    ...
    metabolite_consumption_network_long = cast(  # type: ignore
        pd.DataFrame,
