...
if __name__ == "__main__":
    ...
    model_v1 = metworkpy.read_model(
        MODEL_PATH / "iEK1011_7H9_ADC_glycerol.json"
    )
                ...
                if len(rxn.genes) == 1:
                    ...
                    try:
                        ...
                        if len(model_v1_gene.reactions) == 1:
                            new_id = (
                                model_v1_gene.reactions.__iter__()
                                .__next__()
                                .id
                            )
                            rxn_rename_dict[rxn.id] = new_id
    ...
    argr_rxn_neighborhood_enrich_pval = enrich_df["Rv1657"].rename(
        rxn_rename_dict
    )
